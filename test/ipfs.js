...
describe('ipfs', function () {
  ...
  it('should save file with correct ipfs hash', async () => {
    const content = '1';
  ...
  it('should save object with correct ipld hash', async () => {
  ...
  it('should resolve object props', async () => {
  ...
  it('should resolve trie props', async () => {
    const postsTree = {};
  ...
  it('should correctly convert peerId to string representations', async () => {
  ...
  it('encrypt and decrypt base64 private key', async () => {
